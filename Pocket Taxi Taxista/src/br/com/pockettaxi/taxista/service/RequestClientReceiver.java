 ...
 * 
 */
public class RequestClientReceiver extends BroadcastReceiver {
	private static final String CATEGORIA = "taxi";

	@Override
	public void onReceive(Context contexto, Intent intent) {
		Log.i(CATEGORIA, "RequestClientReceiver > O sistema operacional foi iniciado com sucesso.");
		Log.i(CATEGORIA, "RequestClientReceiver > Iniciando o servico de download...");

		// Agendar o serviço para daqui a 15 segundos
		Log.i(CATEGORIA, "RequestClientReceiver > Agendando o download da imagem...");
		agendar(contexto, 15);

		Log.i(CATEGORIA, "RequestClientReceiver > Fim.");
	}
