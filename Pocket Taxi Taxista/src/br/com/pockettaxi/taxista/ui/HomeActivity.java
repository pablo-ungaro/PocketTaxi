	...
	public void showLogin(final View v) {
		...
		.setPositiveButton("OK",new DialogInterface.OnClickListener() {
			...
			public void onClick(DialogInterface arg0, int arg1) {
				findViewById(R.id.viewParent).setVisibility(View.INVISIBLE);
				findViewById(R.id.txt_info_service).setVisibility(View.VISIBLE);
	...
	private void login(String login) {
		if(Util.loginIsValid(login)){
			...
			startService(new Intent("CHECKER_CLIENT_SERVICE"));
		 	...
		 	Util.showSimpleDialog(HomeActivity.this,handler,R.string.login_invalid);
		}	
